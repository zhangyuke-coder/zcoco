...
public:
	Session(Benchmark* owner, EventLoopThreadPool* scheduler, const IpAddress& server_addr)
			:owner_(owner),
...
public:
	Benchmark(EventLoopThreadPool* scheduler,
...
int main(int argc, char* argv[]) {
	...
	EventLoopThreadPool scheduler(threads_num);
