...
#define LOG_DEBUG if (zcoco::Logger::getLogLevel() <= zcoco::LogLevel::DEBUG) \
													  zcoco::LogWrapper(zcoco::LogEvent::ptr(new zcoco::LogEvent(zcoco::Timestamp::now(), zcoco::Thread::CurrentThreadTid(), zcoco::LogLevel::DEBUG, \
									__FILE__, __LINE__))).getStream()

#define LOG_INFO if (zcoco::Logger::getLogLevel() <= zcoco::LogLevel::INFO) \
													  zcoco::LogWrapper(zcoco::LogEvent::ptr(new zcoco::LogEvent(zcoco::Timestamp::now(), zcoco::Thread::CurrentThreadTid(), zcoco::LogLevel::INFO, \
									__FILE__, __LINE__))).getStream()

#define LOG_WARN zcoco::LogWrapper(zcoco::LogEvent::ptr(new zcoco::LogEvent(zcoco::Timestamp::now(), zcoco::Thread::CurrentThreadTid(), zcoco::LogLevel::WARN, \
									__FILE__, __LINE__))).getStream()

#define LOG_ERROR zcoco::LogWrapper(zcoco::LogEvent::ptr(new zcoco::LogEvent(zcoco::Timestamp::now(), zcoco::Thread::CurrentThreadTid(), zcoco::LogLevel::ERROR, \
									__FILE__, __LINE__))).getStream()

#define LOG_FATAL zcoco::LogWrapper(zcoco::LogEvent::ptr(new zcoco::LogEvent(zcoco::Timestamp::now(), zcoco::Thread::CurrentThreadTid(), zcoco::LogLevel::FATAL, \
									__FILE__, __LINE__))).getStream()
