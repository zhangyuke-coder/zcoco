...
template<> ::echo::UnregisterRequest* Arena::CreateMaybeMessage<::echo::UnregisterRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace echo {
...
class UnregisterRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:echo.UnregisterRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:echo.UnregisterRequest)
 private:
  class _Internal;
...
// required int32 id = 3;
inline bool UnregisterRequest::_internal_has_id() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool UnregisterRequest::has_id() const {
...
inline int32_t UnregisterRequest::_internal_id() const {
  return id_;
}
inline int32_t UnregisterRequest::id() const {
  // @@protoc_insertion_point(field_get:echo.UnregisterRequest.id)
  return _internal_id();
}
inline void UnregisterRequest::_internal_set_id(int32_t value) {
  _has_bits_[0] |= 0x00000001u;
  id_ = value;
}
inline void UnregisterRequest::set_id(int32_t value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:echo.UnregisterRequest.id)
}
